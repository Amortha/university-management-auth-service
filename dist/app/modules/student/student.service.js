...
const getAllStudents = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield student_model_1.Student.find(whereConditons)
      ...
      .skip(skip)
      .limit(limit);
    const total = yield student_model_1.Student.countDocuments(whereConditons);
    return {
      meta: {
        page,
        limit,
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (guardian && Object.keys(guardian).length > 0) {
      Object.keys(guardian).forEach(key => {
        const guardianKey = `guardian.${key}`; //`guardian.firstguardian` `guardian.lastguardian`
        updatedStudentData[guardianKey] = guardian[key]; // updatedStudentData['guardian.motherContactNo']=guardian[motherContactNO]
        //updatedStudentData ---> object create -->gurdian :{motherContactNo:012455}
      });
    }
